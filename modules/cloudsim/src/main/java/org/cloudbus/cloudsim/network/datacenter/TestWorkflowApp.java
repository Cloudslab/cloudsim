...
/**
 * TestWorkflowApp is an example of AppCloudlet having three communicating tasks. Task A and B sends the
 ...
 */
public class TestWorkflowApp extends AppCloudlet {

	public TestWorkflowApp(int type, int appID, double deadline, int numbervm, int userId) {
