...
public abstract class PowerVmAllocationPolicyMigrationAbstract extends PowerVmAllocationPolicyAbstract {
	...
	public List<Double> getExecutionTimeHistoryTotal() {
        ...
        /**
         * Calculate dynamic lower threshold of underUtilized host
         * @param host
         * @return 
         */
        public double getDynamicLowerThr(PowerHost host){
            double lowerThr = 0;
            PowerHostUtilizationHistory _host = (PowerHostUtilizationHistory) host;
            double[] data = _host.getUtilizationHistory();
            double med = MathUtil.median(data);
            lowerThr = Math.pow(1-med, 2);
            return lowerThr;
        }
