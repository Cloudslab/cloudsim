...
public class GoogleDatacenterTest {
	...
	public void setUp() throws Exception {
		...
		preemptableVmAllocationPolicy = new PreemptableVmAllocationPolicy(hostList, hostSelector);
	...
	public void testAllocateThreeVmWithSamePriorityWithWating() {		
		...
		Mockito.when(hostSelector.select(preemptableVmAllocationPolicy.getSortedHosts(), vm2)).thenReturn(null);
