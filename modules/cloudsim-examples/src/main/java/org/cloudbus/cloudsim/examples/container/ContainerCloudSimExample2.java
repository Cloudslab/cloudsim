 ...
 */
public class ContainerCloudSimExample2 {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             *
             * TODO: Remo Andreoli: ContainerAlloctionPolicySimple causes out of bound
             */
            ...
            ContainerDatacenter e = createDatacenter("datacenter", hostList, vmAllocationPolicy, containerAllocationPolicy,
    ...
    private static ArrayList<ContainerVm> createVmList(int brokerId, int containerVmsNumber) {
        ...
        for (int i = 0; i < containerVmsNumber; ++i) {
            ...
            containerVms.add(new ContainerVm(IDs.pollId(ContainerVm.class), brokerId,
    ...
    public static List<ContainerCloudlet> createContainerCloudletList(int brokerId, int numberOfCloudlets)
            throws FileNotFoundException {
        String inputFolderName = ContainerCloudSimExample2.class.getClassLoader().getResource("workload/planetlab").getPath();
